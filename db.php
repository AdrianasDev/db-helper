...
class DB
{
    ...
    * */
   public function dbConnect($dbconfig)
   {
      $this->dbconn = mysql_connect($dbconfig['host'], $dbconfig['user'], $dbconfig['password']);
    ...
    * @param array $fields specifies fields to fetch (optional)
    * @param string $condition specifies rows to fetch (optional, use SQL syntax)
    * @param array $order specifies order of the returned rows. Array has 
    ...
    * @param string $dbtable
    * @param array $data The data to insert, like this: array('field' => 'value')
    */
    ...
    * @param string $dbtable
    * @param array $data The new field values
    * @param $condition Optional. Limit the update to specific rows
    */
